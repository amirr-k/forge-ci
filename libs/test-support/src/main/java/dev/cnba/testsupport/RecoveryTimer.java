 ...
 * always a real timer reading, never an assumed "fast enough". Shared here so the benchmark harness
 * can reuse the exact same measurement instead of building its own.
 */
