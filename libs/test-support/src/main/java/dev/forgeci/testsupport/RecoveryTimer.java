 ...
 * always a real timer reading, never an assumed "fast enough". Shared here so phase 11's
 * benchmark harness can reuse the exact same measurement instead of building its own.
 */
