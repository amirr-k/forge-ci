package dev.cnba.controlplane.api;

import static org.assertj.core.api.Assertions.assertThat;

import dev.cnba.controlplane.api.dto.BuildCreationRequest;
import dev.cnba.controlplane.api.dto.BuildResponse;
import dev.cnba.controlplane.api.dto.PlanSubmissionResponse;
import dev.cnba.controlplane.api.dto.ProjectResponse;
...
import dev.cnba.controlplane.support.ControlPlaneIntegrationTest;
import dev.cnba.controlplane.support.TestFixtures;
import dev.cnba.protocol.ClaimedTaskResponse;
import dev.cnba.protocol.HeartbeatResponse;
import dev.cnba.protocol.TaskResultReportRequest;
import dev.cnba.protocol.WorkerRegistrationRequest;
import dev.cnba.protocol.WorkerRegistrationResponse;
...
@SpringBootTest(
        ...
        properties = {
            "cnba.scheduler.speculation.enabled=true",
            ...
            "cnba.scheduler.speculation.min-elapsed-ms=1000",
            "cnba.scheduler.speculation.multiplier=1.0",
            "cnba.scheduler.speculation.max-per-build=4"
        })
