...
import dev.cnba.controlplane.api.dto.PlanSubmissionRequest;
import dev.cnba.controlplane.api.dto.TaskDefinitionRequest;
import dev.cnba.controlplane.config.S3Properties;
import dev.cnba.controlplane.domain.TaskDefinitionEntity;
import dev.cnba.controlplane.repository.PlanSubmissionRepository;
import dev.cnba.controlplane.support.ControlPlaneIntegrationTest;
import dev.cnba.controlplane.support.ProtocolTestClient;
    ...
    void aWorkerCannotReportResultsOrLogsForALeaseItDoesNotHold() {
        ...
        ClaimedTaskResponse cnbad =
                new ClaimedTaskResponse(
                        ...
                        intruder,
                        UUID.randomUUID().toString());
        assertThat(client.reportResultStatus(cnbad, true, 0, null, null))
