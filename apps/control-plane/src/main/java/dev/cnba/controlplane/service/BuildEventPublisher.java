...
import dev.cnba.controlplane.kafka.BuildEventMessage;
import dev.cnba.controlplane.kafka.KafkaTopics;
 ...
 * to {@code cnba.build-events} — best-effort: a Kafka outage never fails the transition itself,
