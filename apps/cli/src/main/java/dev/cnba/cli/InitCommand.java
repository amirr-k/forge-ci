...
/** Writes a starting {@code cnba.yml}. Never touches an existing one. */
@Command(name = "init", description = "Create a starting cnba.yml in the current directory.")
    ...
    public Integer call() {
        ...
        try {
            ...
            throw new CliException(
                    configFile
                            + " already exists. cnba init never overwrites a configuration — edit that"
        ...
        out.println("Edit the example tasks, then run 'cnba plan'.");
        out.flush();
